export const projectsDetail = [
    ...
    projectInfo: {
      ...
      projectDetails: [
        ...
        },
        {
          id: 2,
          details:
            "This project began with a front-end focused prototype, which has now evolved into a fully functional application with both front-end and back-end functionalities. Get a glimpse of the initial prototype (front-end only) below.",
        },
        {
          id: 3,
          details: "https://seavphov-919d7.web.app/home",
          url: true,
        },
        {
          id: 4,
          details: "Email: virakvary@gmail.com",
        },
        {
          id: 5,
        ...
        },
        {
          id: 6,
          details:
            "Visit Github for more images of a fully functional application!",
        },
      ],
      keyFeatures: [
        {
          ...
          details:
            "Seamless account creation and login process to start sharing and borrowing books.",
        },
        {
          feature: "Forgot Password",
          details:
            "Easily recover your account with our secure password recovery system.",
        },
        {
          feature: "Edit Profile",
          details:
            "Personalize your profile to reflect your reading interests and preferences.",
        },
        {
          feature: "Add Book",
          details:
            "List your old books on Seavphov with detailed information and photos.",
        },
        {
          feature: "Edit Book",
        ...
        },
        {
          ...
          details:
            "Stay updated with notifications about book availability and who saved your listed book.",
        },
        {
          feature: "Search + Filter",
          details: "Find the perfect book using our search and filter options.",
        },
        {
          feature: "Add/Edit/Delete/View Banner",
          details:
            "Manage promotional banners to highlight special announcements or featured books.",
        },
      ],
    },
  },
  {
    ...
    projectImages: [
      ...
      },
      {
        id: 3,
        title: "Plot Graph",
        img: require("@/assets/images/projects/bi2.png"),
      },
    ],
    projectInfo: {
      objectivesDetails:
      ...
      projectDetails: [
        {
          id: 1,
          details:
            "Building on the skills I gained during my first 3-month internship at Khalibre, I undertook this project in my second year of my bachelor's degree.",
        },
        {
          id: 2,
          details:
            "The secure dashboard is accessible only to authenticated users. Users can upload existing CSV files or create new data sets within a user-friendly table format. This data is then utilized to generate various interactive visualizations and calculate key metrics including sum, average, minimum, maximum, and median.",
        },
        {
          id: 3,
          details:
            "Explore visual assets on Github for a deeper look at each feature's functionality.",
        },
      ],
      keyFeatures: [
        {
          feature: "Login/Signup",
          details: "Seamless account creation and login process.",
        },
        {
          feature: "Edit Profile",
          details: "Personalize your profile.",
        },
        {
          feature: "Import & Create Data",
          details:
            "Allows users to import existing data via CSV upload or create new datasets directly within the application's user-friendly table format.",
        },
        {
          feature: "Data Manipulation",
          details:
            "Provides comprehensive data manipulation tools for sorting (ascending/descending), modifying, and deleting entries.",
        },
        {
          feature: "Calculate Key Metrics",
          details:
            "Provides automatic calculations of essential statistical measures including sum, average, minimum, maximum, and median, offering valuable insights into the data's central tendency and spread.",
        },
        {
          feature: "Generate Interactive Visualizations",
          details:
            "Empowers users to transform their data into insightful and customizable charts and graphs, facilitating exploration and analysis.",
        },
        {
          feature: "File Management",
          details:
            "Enables users to rename files for better organization and identification.",
        },
      ],
    },
  },
    ...
    projectInfo: {
      ...
      keyFeatures: [
        ...
        },
        {
          ...
          details:
            "List your visited campsite with build-in location pic on map.",
        },
        {
        ...
        },
        {
          feature: "Rate & Review",
          details:
            "Shape the camping community by leaving star ratings and detailed reviews on campsites you've experienced. Help fellow adventurers find their perfect escape!",
        },
      ],
    },
  },
  {
    singleProjectHeader: {
      ...
      github: true,
      url: "https://github.com/kosalvireak/Flutter-BI",
    },
    projectImages: [
      {
        id: 1,
    ...
    projectInfo: {
      objectivesDetails:
        "A flutter app for application as an Admin for Plot Graph.",
      technologies: [
        {
          techs: ["Flutter", "Node", "MongoDB"],
        },
      ],
      projectDetails: [
        {
      ...
      keyFeatures: [
        ...
        },
        {
          ...
          details:
            "After admin reset password.Email will be sent directly to the user.",
        },
        {
  ...
  {
    singleProjectHeader: {
      singleProjectTitle: "LED Mote",
      singleProjectDate: "Aug, 2022",
      github: true,
      url: "https://github.com/kosalvireak/Respberrypi",
    },
    projectImages: [
      {
        id: 1,
    ...
    projectInfo: {
      objectivesDetails:
        "This project enable user to remote control LED from Laptop(Server) to raspberry pi Zero(Client). The project is based on web socket technology.",
      technologies: [
        {
          techs: [
            "HTML",
      ...
      keyFeatures: [
        ...
        },
        {
          feature: "Notification",
          details:
            "Stay updated with notifications about book availability and other important updates.",
        },
        {
          feature: "Search + Filter",
          details:
            "Find the perfect book using our advanced search and filter options.",
        },
        {
          feature: "Add/Edit/Delete/View Banner",
          details:
        ...
        },
        {
          feature: "Set Banner",
          details:
            "Customize the banner display to engage users with the latest updates and promotions.",
        },
      ],
    },
  },
